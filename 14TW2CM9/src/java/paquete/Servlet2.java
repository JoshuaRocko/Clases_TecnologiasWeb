...
public class Servlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < numeroi; i++) {
            ...
            out.println("context.moveTo("+request.getParameter("x0_"+i)+", "+request.getParameter("y0_"+i)+");");
            out.println("context.lineTo("+request.getParameter("x1_"+i)+", "+request.getParameter("y1_"+i)+");");
